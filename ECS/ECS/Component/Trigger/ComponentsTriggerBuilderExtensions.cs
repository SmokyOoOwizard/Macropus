...
public static class ComponentsTriggerBuilderExtensions
{
	...
	public static ComponentsTriggerBuilder AllOf(this ComponentsTriggerBuilder builder, params Type[] components)
	...
	public static ComponentsTriggerBuilder AnyOf(this ComponentsTriggerBuilder builder, params Type[] components)
	...
	public static ComponentsTriggerBuilder NoneOf(this ComponentsTriggerBuilder builder, params Type[] components)
